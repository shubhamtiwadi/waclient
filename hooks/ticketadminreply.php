...
$hook = array(
    ...
    'description' => 'Executes when a reply is added to a ticket by an admin user.<br>Client Related<br>User ID: {userid}, First Name: {firstname}, Last Name: {lastname}, Email Address: {email}, Company Name: {companyname}, Credit Balance: {credit}, Country: {country}, Currency: {currency}<br>Support Ticket Related<br>Ticket Number: {tid}, Date Created: {date}, Subject: {title}, ID: {ticketid}, Message: {message}, Status: {status}, Priority: {urgency}, Department: {department}, Last Reply Message: {last_reply_message}, Last Reply Date: {last_reply_date}',
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => 'Dear {firstname} {lastname}, ({title}) has been responded by admin.',
